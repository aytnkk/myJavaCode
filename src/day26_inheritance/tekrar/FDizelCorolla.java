package day26_inheritance.tekrar;
    ...
    public static void main(String[] args) {
     ...
     System.out.println(c3.yakit);// T Yakit belirtilmedi
       ...
       ECorolla c2=new FDizelCorolla();
        ...
        System.out.println(((FDizelCorolla) c2).motor); // T  Motor belirtilmedi
        System.out.println(((FDizelCorolla) c2).yakit); // T yakit belirtilmedi
        ...
        System.out.println(((FDizelCorolla) c2).marka);//T Toyota
