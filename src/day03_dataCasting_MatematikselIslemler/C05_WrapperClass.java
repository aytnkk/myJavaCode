...
public class C05_WrapperClass {
    public static void main(String[] args) {
        ...
        char krk1='$';
        System.out.println(Character.isDigit(krk1)); // belirli bir karakterin rakam olup olmadığını belirleyen bir yöntemdir.
        System.out.println(Character.isLetter(krk1)); // false
        // char degerinin bir karakter olup olmadigini degerlendirir
        System.out.println(Character.isAlphabetic(krk1)); // false  degerin alfabetik bir karakter olup olmadigini belirler
