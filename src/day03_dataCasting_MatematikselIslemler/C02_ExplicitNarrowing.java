...
public class C02_ExplicitNarrowing {
    public static void main(String[] args) {
      ...
      java bunu otomotik olarak gerceklestirmez
      sizden sorumluluk almanizi bekler
      ...
      */
        ...
        sayi=130;
        byt=(byte)sayi;// int daha kapsamli oldugu icin atama yapmaz ,bizden mudahale ister
